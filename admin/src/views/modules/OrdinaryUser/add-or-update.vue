<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="User Name" prop="ordinaryusername">
          <el-input v-model="ruleForm.ordinaryusername" 
              placeholder="User Name" clearable  :readonly="ro.ordinaryusername"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="User Name" prop="ordinaryusername">
              <el-input v-model="ruleForm.ordinaryusername" 
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.gender"
                placeholder="Gender" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.profilephoto" label="Profile Photo" prop="profilephoto">
          <file-upload
          tip="Upload"
          action="file/upload"
          :limit="3"
          ...
          @change="profilephotoUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.profilephoto" label="Profile Photo" prop="profilephoto">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.profilephoto.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='ordinaryusername'){
            this.ruleForm.ordinaryusername = obj[o];
	    this.ro.ordinaryusername = true;
            continue;
          }
	            	            if(o=='password'){
	    ...
	    this.ro.gender = true;
            continue;
	            	            ...
	            	            if(o=='profilephoto'){
            this.ruleForm.profilephoto = obj[o];
	    this.ro.profilephoto = true;
            continue;
          }
	            	            if(o=='email'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                        ...
                                                                        profilephotoUploadChange(fileUrls) {
