    ...
    <div v-if="showFlag">
      ...
      <div class="table-content">
        ...
        <el-table-column width="300" :align="contents.tableAlign"
                ...
                label="Click">
                <template slot-scope="scope">
                <el-button v-if="isAuth('config','View') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'Detail':'' }}</el-button>
                <el-button v-if="isAuth('config','View') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'Detail':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('config','View') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'Detail':'' }}</el-button>
                <el-button v-if="isAuth('config','Update') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'Update':'' }}</el-button>
                <el-button v-if="isAuth('config','Update') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'Update':'' }}<i class="el-icon-edit el-icon--right" /></el-button>
                <el-button v-if="isAuth('config','Update') && contents.tableBtnIcon == 0" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'Update':'' }}</el-button>
