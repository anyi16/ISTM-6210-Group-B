<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="FavoriteID" prop="refid">
        <el-input v-model="ruleForm.refid" 
              placeholder="FavoriteID" clearable  :readonly="ro.refid"></el-input>
        </el-form-item>
        <div v-else>
        <el-form-item class="input" label="FavoriteID" prop="refid">
        <el-input v-model="ruleForm.refid" 
                placeholder="FavoriteID" readonly></el-input>
        </el-form-item>
        </div>
      </el-col>
        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Table" prop="tablename">
        <el-input v-model="ruleForm.tablename" 
              placeholder="Table" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
        <el-form-item class="input" label="Table" prop="tablename">
        <el-input v-model="ruleForm.tablename" 
                placeholder="Table" readonly></el-input>
        </el-form-item>
        </div>
      </el-col>
        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="My Favorite" prop="name">
        <el-input v-model="ruleForm.name" 
              placeholder="My Favorite" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
        <el-form-item class="input" label="My Favorite" prop="name">
        <el-input v-model="ruleForm.name" 
                placeholder="My Favorite" readonly></el-input>
        </el-form-item>
        </div>
      </el-col>
        <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Image" prop="picture">
  ...
  data() {
	...
	picture : false,
        ...
        rules: {
                  ...
                  name: [
                            { required: true, message: 'My Favorite cannot be empty', trigger: 'blur' },
                                    	                                                              ],
                  picture: [
                            { required: true, message: 'Image cannot be empty', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
